...
if [ -n "$(git status --porcelain)" ]; then
  ...
  echo -e "\e[0;34mdeploy :: ----------------> No Changes found ";

#enter the user account directory
echo -e "\e[0;34mdeploy :: ----------------> Preparing To Deploy"
cd pwa
...
#build static files
npm run build
echo -e "\e[0;34mdeploy :: ----------------> Static Files Successfully Built"
...
echo -e "\e[0;34mdeploy :: ----------------> Copying Pwa Static Files to App Directory"
mkdir ./../src/views/pages/account
cp -r ./pwa/* ./../src/views/pages/account

echo -e "\e[0;34mdeploy :: ----------------> Static Files Copied to App Directory"

#exit the pwa direcory
cd ..
echo -e "\e[0;34mdeploy :: ----------------> In Root Directory ..."

#add the changes to commit 
echo -e "\e[0;34mdeploy :: ----------------> Adding Changes to Git Commit"
git add .
